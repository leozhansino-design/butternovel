  ...
  return (
    ...
    >
      ...
      <div className="relative w-full rounded-lg overflow-hidden bg-gray-100 shadow-sm group-hover:shadow-md transition-shadow"
        ...
        {showRating && (
          <div className="absolute top-2.5 right-2.5 z-10 bg-white/95 backdrop-blur-sm text-gray-900 px-1.5 py-0.5 rounded shadow-lg flex items-center gap-1 border border-gray-100"
