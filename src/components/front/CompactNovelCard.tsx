  ...
  return (
    ...
    >
      ...
      <div className="relative w-full rounded-lg overflow-hidden bg-gray-100 shadow-sm group-hover:shadow-md transition-shadow"
        ...
        {/* Rating badge - positioned away from rounded corners */}
        {showRating && (
          <div className="absolute top-2 right-2 z-10 bg-white/95 backdrop-blur-sm text-gray-900 px-1.5 py-0.5 rounded shadow-lg flex items-center gap-0.5 border border-gray-100"
      ...
      <div className="mt-2 space-y-0.5">
        ...
        <div className="flex items-center gap-1 text-[10px] text-gray-400">
          ...
          {chaptersCount !== undefined && chaptersCount > 0 && (
