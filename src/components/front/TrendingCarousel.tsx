                  ...
                  <div className="flex-shrink-0">
                    ...
                    >
                      ...
                      {novel.rating && novel.rating > 0 && (
                        <div className="absolute top-2.5 right-2.5 z-10 bg-white/95 backdrop-blur-sm text-gray-900 px-2 py-0.5 rounded shadow-lg flex items-center gap-1 border border-gray-100"
