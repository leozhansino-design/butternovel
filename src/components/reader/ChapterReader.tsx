            ...
            {!hasNext && novel.status === 'COMPLETED' && (
              <div className="mt-16 mb-8">
                ...
                <div className="flex items-center justify-center mb-8">
                  <div className="flex-1 h-px bg-gradient-to-r from-transparent via-[#e8b923] to-transparent opacity-50"></div>
                  <div className="mx-4">
                    <svg className="w-6 h-6 text-[#e8b923]" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                    </svg>
                  </div>
                  <div className="flex-1 h-px bg-gradient-to-r from-[#e8b923] via-[#e8b923] to-transparent opacity-50"></div>
                </div>

                {/* THE END 文字 */}
                <div className="text-center space-y-4">
                  <div className="relative inline-block">
                    <div className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-[#d4a017] via-[#e8b923] to-[#f4d03f] bg-clip-text text-transparent tracking-widest">
                      THE END
                    </div>
                    <div className="absolute inset-0 text-4xl md:text-5xl font-bold bg-gradient-to-r from-[#d4a017] via-[#e8b923] to-[#f4d03f] bg-clip-text text-transparent tracking-widest blur-sm opacity-50">
                      THE END
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-center mt-8">
                  <div className="flex-1 h-px bg-gradient-to-r from-transparent via-[#e8b923] to-[#e8b923] opacity-50"></div>
                  <div className="mx-4">
                    <svg className="w-6 h-6 text-[#e8b923]" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                    </svg>
