  ...
  if (ratings.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-500 text-lg">你还没有发表过评分</p>
        <p className="text-gray-400 text-sm mt-2">去阅读一些小说并给它们评分吧！</p>
      </div>
    )
  }
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-4 mt-3 text-sm text-gray-500">
                  ...
                  <span>•</span>
                  <span>{new Date(rating.createdAt).toLocaleDateString('zh-CN')}</span>
                </div>
              </div>
            </div>
          </div>
