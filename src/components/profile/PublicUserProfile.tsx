...
// Format large numbers (1.1k, 20k, 1m)
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
          ...
          <div className="flex-shrink-0 flex flex-col items-center gap-2">
            ...
            <div className="text-center space-y-1">
              {isOfficial ? (
                <>
                  <div className="flex items-center justify-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-full shadow-lg">
                  ...
                  {/* Follower count below badge - clickable */}
                  <button
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            {/* Stats cards */}
            {isOfficial ? (
              // Official account: only show bio in large card
              <div className="mt-4">
                {/* Bio section - large display for official account */}
                {user.bio && (
                  <div className="backdrop-blur-xl bg-white/40 border border-white/60 rounded-lg p-6 shadow-lg">
                    <p className="text-gray-700 text-base leading-relaxed whitespace-pre-wrap">{user.bio}</p>
                  </div>
                )}
              </div>
            ) : (
